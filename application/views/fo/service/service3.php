...
<br><br>
                                            <div class="button-box has-animation fadeout-element">             
                                                    <div class="clapat-button-wrap parallax-wrap hide-ball">
                                                        <div class="clapat-button parallax-element">
                                                            <div class="button-border outline rounded parallax-element-second">
                                                                <a class="" href="<?php echo base_url("fo/evolutionCtrl/pdf/" . $client['nom_client'] . "/" . $client['nom_categorie'] . "/" . $level['note']) ?>">
                                                        ...
                                                        <div class="clapat-button parallax-element">
                                                            <div class="button-border outline rounded parallax-element-second">
                                                                <a class="" href="<?php echo base_url("fo/evolutionCtrl/listeProgramme") ?>">
                                                                    <span data-hover="Commencer un programme">Commencer un programme</span>
                                                                    </a>
                                                            </div>
                                                    </div>
                                                </div> 
